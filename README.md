...
A high-performance Change Data Capture (CDC) pipeline. This project synchronizes row-level data from MySQL to ClickHouse using Debezium, Apache Spark, Apache Kafka.
